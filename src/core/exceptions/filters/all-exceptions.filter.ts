...
export class AllHttpExceptionsFilter implements ExceptionFilter {
    ...
    //HttpException-ы NestJS (NotFoundException и т.п. из bloggers-platform, ещё не переведённого
    //на DomainException) отдаём с их родным статусом и телом, а не 500
