...
@Module({
  imports: [
    ...
    JwtModule.register({
      secret: ACCESS_TOKEN_SECRET, //TODO: move to configService. will be in the following lessons
      signOptions: { expiresIn: ACCESS_TOKEN_EXPIRES_IN }, // Время жизни токена
    }),
